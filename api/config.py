...
prompt_new_info = "Presiona /new para iniciar un chat nuevo."
unable_to_recognize_content_sent = "El contenido enviado no es reconocido."
group_not_allowed = "Este grupo no está autorizado. Agrega el siguiente ID a ALLOWED_GROUPS y redeploya:"
...
no_profile_photo_info = "No tengo acceso a ninguna foto de perfil pública de esa persona."
